export const ACHIEVEMENTS: Record<string, { icon: string; desc: string }> = {
  "Study Starter": { icon: "📘", desc: "Complete your first study session." },
  "Hangul Hero": { icon: "🇰🇷", desc: "Finish your first daily quest." },
  ...
  "Hangul Explorer": { icon: "🧭", desc: "Complete all three starter topics." },
